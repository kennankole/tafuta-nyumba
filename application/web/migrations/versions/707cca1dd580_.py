...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('business_premises',
    ...
    with op.batch_alter_table('business_premises', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_business_premises_type_of_business_premise', ['type_of_business_premise'], unique=False)
        batch_op.create_index('ix_business_premises_street_name', ['street_name'], unique=False)
        ...
        batch_op.create_index('ix_business_premises_contacts', ['contacts'], unique=False)
        batch_op.create_index('ix_business_premises_constituency', ['constituency'], unique=False)
        batch_op.create_index('ix_business_premises_area', ['area'], unique=False)
        batch_op.create_index('ix_business_premises_alternate_contact', ['alternate_contact'], unique=False)
    ...
    with op.batch_alter_table('houses', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_houses_type_of_house', ['type_of_house'], unique=False)
        batch_op.create_index('ix_houses_price', ['price'], unique=False)
        batch_op.create_index('ix_houses_name_of_estate_or_village', ['name_of_estate_or_village'], unique=False)
        ...
        batch_op.create_index('ix_houses_alternate_contact', ['alternate_contact'], unique=False)

    op.create_table('business_premise',
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('county', sa.VARCHAR(length=64), nullable=True),
    sa.Column('constituency', sa.VARCHAR(length=150), nullable=True),
    sa.Column('ward', sa.VARCHAR(length=150), nullable=True),
    ...
    with op.batch_alter_table('business_premise', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_business_premise_type_of_business_premise', ['type_of_business_premise'], unique=False)
        batch_op.create_index('ix_business_premise_street_name', ['street_name'], unique=False)
        ...
        batch_op.create_index('ix_business_premise_contacts', ['contacts'], unique=False)
        batch_op.create_index('ix_business_premise_constituency', ['constituency'], unique=False)
        batch_op.create_index('ix_business_premise_area', ['area'], unique=False)
        batch_op.create_index('ix_business_premise_alternate_contact', ['alternate_contact'], unique=False)
    ...
    with op.batch_alter_table('hostels', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_hostels_alternate_contact', ['alternate_contact'], unique=False)
    ...
    with op.batch_alter_table('land', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_land_alternate_contact', ['alternate_contact'], unique=False)
