...
class HousesMainMenu(LowerLevelMenu):
    def house_services_menu(self):
        if self.user_response == "1":
            menu_text = "Select type of house to rent\n"
        ...
        if self.user_response == "2":
            menu_text = "Select type of house to rent out\n"
        ...
        if self.user_response == "3":
            menu_text = "Select type of house to buy\n"
        ...
        if self.user_response == "4":
            menu_text = "Select type of house to sell\n"
    ...
    def execute(self):
        ...
        menu = {10: self.house_services_menu()}
