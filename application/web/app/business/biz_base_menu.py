...
class BusinessPremisesMainMenu(LowerLevelMenu):
    def business_premises_services_menu(self):
        if self.user_response == "1":
            menu_text = "Select type of business premise to rent\n"
        ...
        if self.user_response == "2":
            menu_text = "Select type of business premise to rent out\n"
        ...
        if self.user_response == "3":
            menu_text = "Select type of business premise to buy\n"
        ...
        if self.user_response == "4":
            menu_text = "Select type of business premise to sell\n"
